module type HEADERS = sig
  ...
  (* val iter : (string -> string list -> unit) -> t -> unit val map :
     (string -> string list -> string list) -> t -> t val fold :
     (string -> string -> 'a -> 'a) -> t -> 'a -> 'a*)
...
module HeadersMap : HEADERS

module HeadersAssoc : HEADERS

module HeadersAssocAlt : HEADERS
